...
const Footer = () => {
  return (
    <motion.footer
      ...
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 1 }} // You can adjust duration as needed
    >
        ...
        <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
          <div className="flex w-full justify-center  space-x-12 text-gray-600 dark:text-gray-300 sm:w-7/12 md:justify-start">
            <ul className="list-inside list-disc space-y-8">
              ...
              <li><a href="/temple-history" className="transition hover:text-primary">Temple-History</a></li>
              <li><a href="/idol-details" className="transition hover:text-primary">idol-details</a></li>
              <li><a href="/dashavatara" className="transition hover:text-primary">Dashavatara</a></li>
              <li><a href="#seva" className="transition hover:text-primary">Seva</a></li>
              
            </ul>
            <ul className="list-inside list-disc space-y-8">
  <li><a href="https://alumni.sitmng.ac.in" className="transition hover:text-primary">Alumni</a></li>
  <li><a href="https://www.sitmng.ac.in" className="transition hover:text-primary">SIT</a></li>
</ul>
